...
<head>
    ...
    <!-- Vincula el archivo de validación de JavaScript -->
    <script src="${pageContext.request.contextPath}/js/realizarReservaValidation.js"></script>
    <script>
        /**
         * Función para actualizar las pistas disponibles automáticamente en función de los filtros seleccionados.
         */
...
<body>
    ...
    <!-- Formulario para filtrar pistas -->
    ...
    <form action="${pageContext.request.contextPath}/client/realizarReservaBono" method="post" onsubmit="return validarFormulario();">
